...
export interface ApiInsightListingInsightListing
  extends Struct.SingleTypeSchema {
  collectionName: 'insight_listings';
  info: {
    displayName: 'Insight Listing';
    pluralName: 'insight-listings';
    singularName: 'insight-listing';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::insight-listing.insight-listing'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::insight-listing.insight-listing': ApiInsightListingInsightListing;
